    ...
    <>
      ...
      <div className="hidden gap-2 lg:grid lg:grid-cols-[1fr_320px]">
        <button
          type="button"
          onClick={() => setAberta(0)}
          className="group relative aspect-[16/10] overflow-hidden rounded-2xl bg-ground"
        >
          <Foto
            src={imgs[0]}
          ...
          />
          {video ? (
            <span className="absolute bottom-4 left-4 inline-flex items-center gap-2 rounded-xl bg-white px-3.5 py-2 text-[13px] font-medium text-ink shadow-float transition-colors group-hover:bg-ground">
